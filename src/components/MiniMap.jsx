...
export default function MiniMap({ nodes, pan, zoom, canvasRef }) {
  ...
  // Canvas-målene leses i effekt (refs kan ikke leses under render) og
  // følger vindus-/layoutendringer
  ...
  return (
    <div className="mini-map">
      ...
      <svg width={MINI_W} height={MINI_H} style={{ display: "block", background: "var(--minimap-bg)" }}>
        ...
        {(() => {
          // Klipp indikatoren i BEGGE ender. Ren clamping av x/y uten å
          // krympe bredde/høyde markerte et område som lå feil.
